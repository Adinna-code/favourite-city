import { Box, Container, Heading, ListItem, ListRoot, Text } from "@chakra-ui/react";
        ...
        {favorites.length > 0 ? (
          <ListRoot spacing={3} mt={4} textAlign="left">
            {favorites.map((favorite) => (
              ...
              >
                <Text fontWeight="bold" color="orange.600">{favorite.cityName}</Text>
                <Text fontSize="sm" color="gray.600">{favorite.country}</Text>
              </ListItem>
            ))}
          </ListRoot>
        ) : (
