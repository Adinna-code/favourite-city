...
import { Container, Input, List, Heading, Text, Box, Stack, Spinner } from "@chakra-ui/react"
...
export default function Search() {
  ...
  return(
    <Container p={4} maxW="container.md" bg="orange.50" borderRadius="lg" boxShadow="xl" centerContent>
      <Box textAlign="center" p={6} borderRadius="md" bg="yellow.100" boxShadow="lg" mb={6}>
        <Heading size="xl" color="orange.600" mb={4}>Search Cities</Heading>
        <Stack gap="4">
          <Input 
